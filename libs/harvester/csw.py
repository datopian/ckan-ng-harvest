...
class CSWSource:
    ...
    'organization': 'OpenTopography Facility',
    'title': 'LUSI Mud Volcano: July 1, 2018',
    'abstract': 'Point Cloud and Temperature Orthophoto of LUSI ...

    <gmd:MD_Metadata xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd">
    <gmd:fileIdentifier>
        <gco:CharacterString>OTDS.082019.32749.1</gco:CharacterString>
    </gmd:fileIdentifier>
    <gmd:language>
    ...
    <gmd:contact>
        ...
        <gmd:organisationName>
            <gco:CharacterString>OpenTopography Facility</gco:CharacterString>
        </gmd:organisationName>
        <gmd:contactInfo>
            <gmd:CI_Contact>
            <gmd:address>
                ...
                <gmd:electronicMailAddress>
                    <gco:CharacterString>info@opentopography.org</gco:CharacterString>
                </gmd:electronicMailAddress>
                </gmd:CI_Address>
            </gmd:address>
            </gmd:CI_Contact>
    ...
    <gmd:referenceSystemInfo>
        ...
        <gmd:referenceSystemIdentifier>
            <gmd:RS_Identifier>
            <gmd:code>
                <gco:CharacterString>WGS 84 / UTM zone 49S [EPSG: 32749]</gco:CharacterString>
            </gmd:code>
            </gmd:RS_Identifier>
        </gmd:referenceSystemIdentifier>
        </gmd:MD_ReferenceSystem>
    ...
    <gmd:identificationInfo>
        ...
        <gmd:citation>
            <gmd:CI_Citation>
            <gmd:title>
                <gco:CharacterString>LUSI Mud Volcano: July 1, 2018</gco:CharacterString>
            </gmd:title>
            <gmd:date>
                <gmd:CI_Date>
                <gmd:date>
        ...
        <gmd:abstract>
            <gco:CharacterString>Point Cloud and Temperature Orthophoto of LUSI Mud Volcano
    ...
    Images: 445 photographs (available upon request)</gco:CharacterString>
        </gmd:abstract>
        <gmd:pointOfContact>
            <gmd:CI_ResponsibleParty>
            <gmd:organisationName>
            ...
            <gmd:contactInfo>
                ...
                <gmd:onlineResource>
                    ...
                    <gmd:linkage>
                        <gmd:URL>https://opentopography.org</gmd:URL>
                    </gmd:linkage>
                    </gmd:CI_OnlineResource>
                </gmd:onlineResource>
                </gmd:CI_Contact>
            ...
            <gmd:role>
                <gmd:CI_RoleCode codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_RoleCode" codeListValue="originator" codeSpace="ISOTC211/19115">publisher</gmd:CI_RoleCode>
            </gmd:role>
            </gmd:CI_ResponsibleParty>
        </gmd:pointOfContact>
        <gmd:pointOfContact>
            <gmd:CI_ResponsibleParty>
            <gmd:individualName>
                <gco:CharacterString>Brett Carr</gco:CharacterString>
            </gmd:individualName>
            <gmd:organisationName>
                <gco:CharacterString>Lamont-Doherty Earth Observatory</gco:CharacterString>
            </gmd:organisationName>
            <gmd:contactInfo>
                <gmd:CI_Contact>
                <gmd:address>
                    <gmd:CI_Address>
                    <gmd:electronicMailAddress>
                        <gco:CharacterString>bcarr@ldeo.columbia.edu</gco:CharacterString>
                    </gmd:electronicMailAddress>
                    </gmd:CI_Address>
                </gmd:address>
                <gmd:onlineResource>
            ...
            <gmd:role>
                <gmd:CI_RoleCode codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_RoleCode" codeListValue="originator" codeSpace="ISOTC211/19115">distributor</gmd:CI_RoleCode>
            </gmd:role>
            </gmd:CI_ResponsibleParty>
        </gmd:pointOfContact>
        <gmd:language>
        ...
        <gmd:extent>
            ...
            <gmd:geographicElement>
                ...
                <gmd:westBoundLongitude>
                    <gco:Decimal>112.704048323978</gco:Decimal>
                </gmd:westBoundLongitude>
                <gmd:eastBoundLongitude>
                    <gco:Decimal>112.719378336369</gco:Decimal>
                </gmd:eastBoundLongitude>
                <gmd:southBoundLatitude>
                    <gco:Decimal>-7.53403286112932</gco:Decimal>
                </gmd:southBoundLatitude>
                <gmd:northBoundLatitude>
                    <gco:Decimal>-7.5201353969704</gco:Decimal>
                </gmd:northBoundLatitude>
                </gmd:EX_GeographicBoundingBox>
            </gmd:geographicElement>
            </gmd:EX_Extent>
    ...
    <gmd:distributionInfo>
        ...
        <gmd:transferOptions>
            ...
            <gmd:onLine>
                <gmd:CI_OnlineResource>
                <gmd:linkage>
                    <gmd:URL>https://doi.org/10.5069/G9Q81B6D</gmd:URL>
                </gmd:linkage>
                <gmd:protocol>
                ...
                <gmd:description>
                    <gco:CharacterString>Navigate directly to the URL for data access and download.</gco:CharacterString>
                </gmd:description>
                </gmd:CI_OnlineResource>
            </gmd:onLine>
            </gmd:MD_DigitalTransferOptions>
    ...
    'identifier': '{F7AD63D2-2770-4D9E-B6C2-3A53E77D0CE8}',
    'title': 'NAIP 2018 Imagery for North Carolina - USDA',
    'abstract': 'The National Agriculture Imagery Program (NAIP) acquires aerial imagery ...

    <gmd:MD_Metadata xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:srv="http://www.isotc211.org/2005/srv">
        <gmd:fileIdentifier>
            <gco:CharacterString>{F7AD63D2-2770-4D9E-B6C2-3A53E77D0CE8}</gco:CharacterString>
        </gmd:fileIdentifier>
        <gmd:language>
            <gco:CharacterString>en</gco:CharacterString>
        </gmd:language>
        ...
        <gmd:contact>
            <gmd:CI_ResponsibleParty>
                <gmd:organisationName>
                    <gco:CharacterString>US Department of Agriculture, Farm Service Agency</gco:CharacterString>
                </gmd:organisationName>
                <gmd:role>
                    <gmd:CI_RoleCode codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_RoleCode" codeListValue="custodian" codeSpace="ISOTC211/19115">custodian</gmd:CI_RoleCode>
                </gmd:role>
            </gmd:CI_ResponsibleParty>
        </gmd:contact>
        <gmd:dateStamp>
            <gco:Date>2018-12-11</gco:Date>
        </gmd:dateStamp>
        <gmd:metadataStandardName>
        ...
        <gmd:identificationInfo>
            <srv:SV_ServiceIdentification>
                <gmd:citation>
                    <gmd:CI_Citation>
                        <gmd:title>
                            <gco:CharacterString>NAIP 2018 Imagery for North Carolina - USDA</gco:CharacterString>
                        </gmd:title>
                        <gmd:date>
                            <gmd:CI_Date>
                                <gmd:date>
                ...
                <gmd:abstract>
                    <gco:CharacterString>The National Agriculture Imagery Program (NAIP) acquires aerial imagery during the agricultural growing seasons in the continental US A primary goal of the NAIP program is to make digital ortho photography available to governmental agencies and the public within a year of acquisition.
    ...
    For more information please see: http://www.fsa.usda.gov/programs-and-services/aerial-photography/imagery-programs/naip-imagery</gco:CharacterString>
                </gmd:abstract>
                <gmd:descriptiveKeywords>
                    <gmd:MD_Keywords>
                        <gmd:keyword>
                            <gco:CharacterString>USDA</gco:CharacterString>
                        </gmd:keyword>
                        <gmd:keyword>
                        ...
                        <gmd:keyword>
                            <gco:CharacterString>leaf-on</gco:CharacterString>
                        </gmd:keyword>
                        <gmd:keyword>
                            <gco:CharacterString>aerial photography</gco:CharacterString>
                        </gmd:keyword>
                        <gmd:keyword>
                            <gco:CharacterString>aerials</gco:CharacterString>
                        </gmd:keyword>
                    </gmd:MD_Keywords>
                </gmd:descriptiveKeywords>
                <srv:serviceType>
                    <gco:LocalName>urn:x-esri:specification:ServiceType:ArcGIS</gco:LocalName>
                </srv:serviceType>
                <srv:extent>
                    <gmd:EX_Extent>
                        <gmd:geographicElement>
                            <gmd:EX_GeographicBoundingBox>
                                <gmd:westBoundLongitude>
                                    <gco:Decimal>-84.4524</gco:Decimal>
                                </gmd:westBoundLongitude>
                                <gmd:eastBoundLongitude>
                                    <gco:Decimal>-75.298</gco:Decimal>
                                </gmd:eastBoundLongitude>
                                <gmd:southBoundLatitude>
                                    <gco:Decimal>33.7651</gco:Decimal>
                                </gmd:southBoundLatitude>
                                <gmd:northBoundLatitude>
                                    <gco:Decimal>36.717</gco:Decimal>
                                </gmd:northBoundLatitude>
                            </gmd:EX_GeographicBoundingBox>
                        </gmd:geographicElement>
                    </gmd:EX_Extent>
                ...
                <srv:couplingType>
                    <srv:SV_CouplingType codeList="http://schemas.opengis.net/iso19119/couplingType" codeListValue="tight" codeSpace="ISOTC211/19115">tight</srv:SV_CouplingType>
                </srv:couplingType>
                <srv:containsOperations>
                    <srv:SV_OperationMetadata>
                        ...
                        <srv:DCP>
                            <srv:DCPList codeList="http://www.fgdc.gov/nap/metadata/register/codelists.html#IC_112" codeListValue="WebServices" codeSpace="ISOTC211/19115">WebServices</srv:DCPList>
                        </srv:DCP>
                        <srv:connectPoint>
                            <gmd:CI_OnlineResource>
                                <gmd:linkage>
                                    <gmd:URL>https://gis.apfo.usda.gov/arcgis/rest/services/NAIP/USDA_CONUS_PRIME/ImageServer</gmd:URL>
                                </gmd:linkage>
                            </gmd:CI_OnlineResource>
                        </srv:connectPoint>
                    </srv:SV_OperationMetadata>
    ...
    def md_metadata_to_dict(self, mdm):
        ...
        ret = {}
        ret['xml'] = str(mdm.xml)  # it's a bytes type
